        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameMasterId = table.Column<string>(type: "text", nullable: false, defaultValue: ""),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    System = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignPlayers_CampaignId_CharacterName",
                table: "CampaignPlayers",
                columns: new[] { "CampaignId", "CharacterName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Campaigns_GuildId_Name",
                table: "Campaigns",
